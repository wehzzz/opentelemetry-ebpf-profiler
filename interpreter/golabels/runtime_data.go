...
func getOffsets(vers string) support.GoLabelsOffsets {
	offsets := support.GoLabelsOffsets{
		...
		// gobuf.sp is at offset 0 within gobuf, gobuf.pc is at offset 8 within gobuf.
	...
	if version.Compare(vers, "go1.26") >= 0 {
		offsets.Curg = 184
		offsets.Labels = 352
		// gobuf.ret removed in Go 1.25: gobuf.bp shifts from offset 48 to 40 within gobuf.
		// Absolute: 56 + 40 = 96.
